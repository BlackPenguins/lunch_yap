...
function buildHeader( $pageName ) {
    ...
    echo "<body>";
        ...
        echo "<div class='header-section'>";
            echo "<span class='filter-button disabled' title='Hub' id='hub_button'><i class='material-icons'>hub</i></span>";
            ...
            echo "<span class='tagline'>One place to see all places to eat for lunch.</span>";
                ...
                if( $pageName == "Home" ) {
                    ...
                    echo "<span class='filter-button disabled' title='Walking Distance' id='walk_button'><i class='material-icons'>directions_walk</i></span>";
                    echo "<span class='filter-button disabled' title='Short Drive Distance' id='short_button'><i class='material-icons'>pedal_bike</i></span>";
                    echo "<span class='filter-button disabled' title='Long Drive Distance' id='long_button'><i class='material-icons'>airport_shuttle</i></span>";
